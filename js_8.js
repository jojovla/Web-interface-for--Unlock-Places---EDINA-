...
//=========================function for the alert box. Handle the delete method (hide the alert box rather than deleting it)
$(function () {
    ...
    $("#location").autocomplete({
            ...
            select: function (event, ui) {
                var featureGroup = L.featureGroup().addTo(map),
                    cityName = ui.item.feature.properties.name, // using this in the marker pop-up
                    featureTypeName = ui.item.feature.properties.featuretype, // using this in the marker pop-up
                ...
                //if, else statement for the icons in the popups
                ...
                //this code manipulates how the elements of the autocomplete menu will appear
                .data("uiAutocomplete")._renderItem = function (ul, item) { 
                    ...
                    return $("<li />") //make a new li
                        .data("item.autocomplete", item) 
                        .append("<a>" + "<img src='" + image + "' height='18' width='18'> <b>" + item.label + "</b>," + "<i> " + item.featuretype + "</i>" + "</a>") 
                        .appendTo(ul);
                };
...
$(function () {
        ...
        source: function (request, response) {
            $.get("http://unlock.edina.ac.uk/ws/search?name=" + request.term + "*&format=json&maxRows=999")
                .success(function (data) {
                    ...
                    }; response(names); // send the array to the autocomplete to display it
                });
        },
        select: function (event, ui) {
    ...
    .data("uiAutocomplete")._renderItem = function (ul, item) { 
        return $("<li />") 
            .data("item.autocomplete", item) 
            .append("<a>" + "<img src='polygon1.png' height='18' width='18'>  " + item.label + "," + "<small><i> " + item.featuretype + "</small></i>" + "</a>") 
            .appendTo(ul);
    };
});
//............................................ end Location2 ..........................................

//=================================================Feature type (orange button)===============================================================
$(function () {
...
// ...............show current coordinates when the cursor is moving............ 
...
//======================================= Find and draw the features within a rectangular=======================================================
var marker1;
function findAndDrawFeaturesOnMap(features, geoJSONUrl, drawnLayer) {
                    ...
                    for (var i = 0; i < alldata.footprints.length; i++) {
                        for (var j = 0; j < alldata.footprints[i].geometry.coordinates.length; j++) {
                            ...
                            if (alldata.footprints[i].geometry.type == "Point") {
                                //add information in the popup window
    ...
    $.when.apply(null, ajax_calls).
        ...
        if (featureGroup.getLayers().length) {
            ...
            $(".alert").alert().show();
            // add error message when no resutls were found
        }
    }).then(function () {
        // hide loader
